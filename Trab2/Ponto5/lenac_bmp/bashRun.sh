...
for file in ../../Ponto1/files2/*
do
  python3 ../../compressUtils/compress_lz4.py -i "$file" -d "files/dict_reduced_lenac_32kiB.txt" >> results_lz4.txt
done

for file in ../../Ponto1/files2/*
do
  python3 ../../compressUtils/compress_zstd.py -i "$file" -d "files/dict_reduced_lenac_32kiB.txt" >> results_zstd.txt
done
